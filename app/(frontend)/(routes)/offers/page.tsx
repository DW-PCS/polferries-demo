  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-6 text-[#003d7a]">Promocje</h1>
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">Aktualne promocje</h2>
          <p className="text-gray-700 mb-4">
            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">Oferty specjalne</h2>
          <p className="text-gray-700 mb-4">
